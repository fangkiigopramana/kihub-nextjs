            ...
            <div className="container mx-auto">
                <div className="grid md:grid-cols-2 gap-12">
                    <div className="lg:w-3/4">
                        <p className="mt-3 text-gray-300 dark:text-neutral-400">
                    ...
                    <div className="space-y-6 lg:space-y-10">
                        <div className="flex gap-x-5 sm:gap-x-8">
                            <span className="shrink-0 inline-flex justify-center items-center size-[46px] rounded-full border border-gray-200 bg-white text-gray-200 shadow-sm mx-auto dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-200">
                            ...
                            <div className="grow">
                                <h3 className="text-base sm:text-lg font-semibold text-gray-200 dark:text-neutral-200">
