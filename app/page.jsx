      ...
      <div className="container mx-auto h-full text-center mt-10">
        <div className="flex flex-col xl:flex-row items-center justify-between xl:pt-8 xl:pb-24">
          <div className="text-center xl:text-left order-2 xl:order-none">
            ...
            <p class="max-w-[500px] mb-9 text-white/80">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Repudiandae cupiditate inventore mollitia voluptates corrupti. Quo atque maxime non et! Cupiditate.</p>
